...
if (loading) {
return ( <SettlementShell
     tripId={tripId}
   > <div className="flex min-h-[60vh] items-center justify-center"> <div className="text-center"> <Loader2
           size={32}
...
return ( <main className="min-h-screen bg-[#f4f0e6] text-[#191917]">
<div
...
> <header className="sticky top-0 z-50 border-b border-[#292a25]/10 bg-[#f4f0e6]/95 backdrop-blur-xl"> <div className="mx-auto flex h-[82px] max-w-[1450px] items-center justify-between px-5 md:px-8">
<Link
href={`/trip/${tripId}`}
...
return ( <div className="rounded-[25px] border border-[#292a25]/10 bg-[#f8f5ec] p-5 shadow-[0_10px_35px_rgba(40,40,30,.035)]"> <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#e8e5d9] text-[#566055]">
{icon} </div>
...
return ( <div className="rounded-[24px] border border-[#292a25]/8 bg-white p-4 md:p-5"> <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between"> <div className="flex min-w-0 items-center gap-3"> <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#f0e9d8] text-[#6c5d38]"> <UserRound size={18} /> </div>
...
return ( <section className="rounded-[30px] border border-[#292a25]/10 bg-[#f8f5ec] p-6 shadow-[0_15px_50px_rgba(40,40,30,.04)]"> <p className="text-[10px] font-bold uppercase tracking-[.2em] text-[#927543]">
Balance </p>
...
return ( <div className="rounded-[24px] border border-dashed border-[#292a25]/15 bg-[#f4f0e6] px-6 py-12 text-center"> <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[#e8e5d9] text-[#566055]"> <WalletCards
       size={23}
     /> </div>
